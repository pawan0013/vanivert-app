    ...
    <div style={{minHeight:'100dvh',background:BG,fontFamily:'system-ui,sans-serif',color:INK}}>
      ...
      <main style={{maxWidth:760,margin:'0 auto',padding:'64px 32px 80px'}}>
        ...
        <Section title="Vos droits">
          <p>Conformement au RGPD, vous disposez d&apos;un droit d&apos;acces, de rectification, de suppression et de portabilite de vos donnees. Pour exercer ces droits, contactez : <a href="mailto:contact@vanivert.fr" style={{color:BLUE}}>contact@vanivert.fr</a></p>
        </Section>
