...
function Article1() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Ce que dit vraiment la loi</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>L'annuaire centralise : le piege que personne n'explique</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Les formats legaux</h2>
...
function Article2() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Le calcul exact</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Pourquoi le repondeur ne suffit pas</h2>
      <ul style={{ paddingLeft: 24, color: '#374151', lineHeight: 2 }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Les secteurs les plus exposes en Bretagne</h2>
...
function Article3() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: '#374151' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>C'est quoi, l'annuaire centralise DGFiP ?</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: INK, marginBottom: 14, marginTop: 36 }}>Comment eviter ce piege en 3 etapes</h2>
...
export default function BlogPost({ params }: { params: { slug: string } }) {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: CREAM, fontFamily: 'Inter, sans-serif' }}>
      {/* Nav */}
      <nav style={{ padding: '18px 40px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: '#fff', borderBottom: `1px solid ${BORDER}`, position: 'sticky', top: 0, zIndex: 100 }}>
        <a href="/" style={{ fontWeight: 400, fontSize: 18, color: INK, textDecoration: 'none', fontFamily: 'Instrument Serif, Georgia, serif', display: 'flex', alignItems: 'center', gap: 8 }}>
          <div style={{ width: 26, height: 26, borderRadius: 7, background: 'linear-gradient(135deg, #5B4CF5, #4338CA)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ fontStyle: 'italic', fontSize: 13, color: '#fff' }}>v</span>
          </div>
          vanivert
        </a>
        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
          <a href="/blog" style={{ fontSize: 13, color: MID, textDecoration: 'none' }}>Retour au blog</a>
          <a href="/calculateur" style={{ background: VI, color: '#fff', fontSize: 13, fontWeight: 600, borderRadius: 8, padding: '8px 18px', textDecoration: 'none' }}>Calculer mon risque</a>
        </div>
      </nav>

      {/* Hero image */}
      <div style={{ height: 360, overflow: 'hidden', position: 'relative', background: D }}>
      ...
      {/* Meta */}
      <div style={{ background: '#fff', borderBottom: `1px solid ${BORDER}`, padding: '14px 40px' }}>
      ...
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 40px 80px' }}>
        ...
        {/* Author */}
        <div style={{ marginTop: 52, padding: '22px 26px', background: '#fff', borderRadius: 16, border: `1px solid ${BORDER}`, display: 'flex', gap: 16, alignItems: 'flex-start' }}>
