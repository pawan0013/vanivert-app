...
function Article1() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.75)' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Ce que dit vraiment la loi</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>L'annuaire centralise : le piege que personne n'explique</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Les formats legaux</h2>
...
function Article2() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.75)' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Le calcul exact</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Pourquoi le repondeur ne suffit pas</h2>
      <ul style={{ paddingLeft: 24, color: '#374151', lineHeight: 2 }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Les secteurs les plus exposes en Bretagne</h2>
...
function Article3() {
  return (
    <div style={{ fontFamily: 'Georgia, serif', fontSize: 16, lineHeight: 1.8, color: 'rgba(255,255,255,0.75)' }}>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>C'est quoi, l'annuaire centralise DGFiP ?</h2>
      ...
      <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 22, fontWeight: 700, color: 'rgba(255,255,255,0.92)', marginBottom: 14, marginTop: 36 }}>Comment eviter ce piege en 3 etapes</h2>
...
export default function BlogPost({ params }: { params: { slug: string } }) {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: '#050608', fontFamily: 'system-ui, -apple-system, sans-serif', color: 'rgba(255,255,255,0.88)' }}>
      {/* Nav */}
      <nav style={{ padding: '14px 32px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'rgba(5,6,8,0.94)', borderBottom: '1px solid rgba(255,255,255,0.07)', position: 'sticky', top: 0, zIndex: 100, backdropFilter: 'blur(20px)' }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <a href="/blog" style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)', textDecoration: 'none', padding: '6px 14px', borderRadius: 980, border: '1px solid rgba(255,255,255,0.10)' }}>Retour au blog</a>
      ...
      {/* Meta */}
      <div style={{ background: 'rgba(5,6,8,0.95)', borderBottom: '1px solid rgba(255,255,255,0.07)', padding: '14px 40px' }}>
      ...
      {/* Article */}
      <div style={{ maxWidth: 760, margin: '0 auto', padding: '48px 40px 80px', background: '#050608' }}>
        ...
        {/* Author */}
        <div style={{ marginTop: 52, padding: '22px 26px', background: 'rgba(255,255,255,0.04)', borderRadius: 16, border: '1px solid rgba(255,255,255,0.08)', display: 'flex', gap: 16, alignItems: 'flex-start' }}>
